...
$tiles = "C:\Users\justi\Cozy-Platformer\assets\tiles"
$map = [ordered]@{
  "118.jpg" = (Join-Path $props "drip.png")
  "119.jpg" = (Join-Path $props "mite.png")
  "120.jpg" = (Join-Path $props "hopper.png")
  "121.jpg" = (Join-Path $props "sign.png")
  "122.jpg" = (Join-Path $props "crab.png")
  "123.jpg" = (Join-Path $tiles "meadow-grass-top.png")
  "124.jpg" = (Join-Path $props "item-block.png")
}
foreach ($k in $map.Keys) {
  Key-And-Crop (Join-Path $src $k) $map[$k]
}
